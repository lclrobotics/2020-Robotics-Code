...
import org.firstinspires.ftc.teamcode.Skystone.PIDController;

@Autonomous(name="Omni Drive Avoid PID", group="Exercises")
//@Disabled
public class OmniDriveAvoidPid extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive())
        {
            ...
            robot.frontleftDrive.setPower(-(power + correction));
            robot.backleftDrive.setPower(-(power + correction));
            //rightMotor.setPower(power + correction);
            robot.frontrightDrive.setPower(-(power + correction));
